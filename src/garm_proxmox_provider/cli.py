...
The CLI also exposes utility sub-groups for humans:
  garm-proxmox-provider admin setup-proxmox ...
  garm-proxmox-provider debug test-connection
  garm-proxmox-provider debug list-templates
  garm-proxmox-provider debug lint-config
"""
...
# ---------------------------------------------------------------------------
# GARM lifecycle commands (invoked by the controller via env vars)
# ---------------------------------------------------------------------------
